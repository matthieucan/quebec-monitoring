#!/usr/bin/python
# -*- coding: utf-8 -*-
"""Checks the number of users (registered, online) on reseaucontact.com.
"""
#
#
...
#
#     File :
#               check_reseaucontactcom.py Checks the number of users (registered, online) on reseaucontact.com.
#
#
...
PLUGIN_NAME = "check_reseaucontactcom"
PLUGIN_VERSION = "0.1"
STATE_OK = 0
STATE_WARNING = 1
STATE_CRITICAL = 2
...
def get_data(args):
    ...
    data1 = tree.xpath('//section[@id="widget-community-stats"]//h2[@class="totalMembers"]/text()')
    data2 = tree.xpath('//section[@id="widget-community-stats"]//h2[@class="onlineMembers"]/text()')
    ...
    if len(data1) == len(data2) == 1:
        ...
        for data in [data1, data2]:
            ...
            try:
                ...
                print('Wrong data received: %s' % result)
            
            stats.append(result)
        
        print('OK - %d members, %d online|'
              'members=%d;;;0;; '
              'online=%d;;;0;;' % tuple(stats * 2))
        sys.exit(STATE_OK)
